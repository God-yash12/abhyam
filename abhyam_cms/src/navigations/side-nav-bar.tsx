...
const SideNavBar: React.FC<SideNavBarProps> = ({ toggleSidebar }) => {
    ...
    return (
        <div className="no-scroolbar relative p-4 bg-gray-700 h-full overflow-y-scroll">
            ...
            <nav>
                <h1 className="text-sm font-poppins text-gray-400 px-4 mt-2">Abhyam Academy</h1>
                    ...
                    return (
                        <div key={data.id}>
                            <ul className="mt-2">
                                <Link
                                    to={data.path}
                                    className={`text-gray-300 font-poppins py-2 px-2 hover:bg-gray-700 rounded flex justify-between items-center ${isItemActive ? "bg-gray-700" : ""
                                        }`}
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-5">
                        <Link to="/add-admin">
                            <SecondaryButton
                                className="w-full border-white py-1">Add Admin</SecondaryButton>
                        </Link>
                        <div>
                            <SecondaryButton
                                // onClick={handleLogout}
                                className=" bg-transparent w-full border-white">Logout</SecondaryButton>
                        </div>
                    </div>
                </div>
            </nav>
